...
class SmartCookieWebClient(
    ...
    private fun chooseAdBlocker(): AdBlocker = if (userPreferences.adBlockEnabled && userPreferences.adBlockType != AdBlockChoice.NONE && userPreferences.adBlockType != AdBlockChoice.ELEMENT) {
